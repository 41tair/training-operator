...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubeflow/training-operator/pkg/apis/v1.ElasticPolicy":  schema_training_operator_pkg_apis_v1_ElasticPolicy(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MPIJob":         schema_training_operator_pkg_apis_v1_MPIJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MPIJobList":     schema_training_operator_pkg_apis_v1_MPIJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MPIJobSpec":     schema_training_operator_pkg_apis_v1_MPIJobSpec(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MXJob":          schema_training_operator_pkg_apis_v1_MXJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MXJobList":      schema_training_operator_pkg_apis_v1_MXJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MXJobSpec":      schema_training_operator_pkg_apis_v1_MXJobSpec(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.MXJobStatus":    schema_training_operator_pkg_apis_v1_MXJobStatus(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJob":     schema_training_operator_pkg_apis_v1_PyTorchJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJobList": schema_training_operator_pkg_apis_v1_PyTorchJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJobSpec": schema_training_operator_pkg_apis_v1_PyTorchJobSpec(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.RDZVConf":       schema_training_operator_pkg_apis_v1_RDZVConf(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.TFJob":          schema_training_operator_pkg_apis_v1_TFJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.TFJobList":      schema_training_operator_pkg_apis_v1_TFJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.TFJobSpec":      schema_training_operator_pkg_apis_v1_TFJobSpec(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJob":     schema_training_operator_pkg_apis_v1_XGBoostJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJobList": schema_training_operator_pkg_apis_v1_XGBoostJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJobSpec": schema_training_operator_pkg_apis_v1_XGBoostJobSpec(ref),
	}
}
...
func schema_training_operator_pkg_apis_v1_ElasticPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.RDZVConf"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.RDZVConf", "k8s.io/api/autoscaling/v2beta2.MetricSpec"},
	}
}

func schema_training_operator_pkg_apis_v1_MPIJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.MPIJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/v1.MPIJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_MPIJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.MPIJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.MPIJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_MPIJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_training_operator_pkg_apis_v1_MXJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.MXJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/v1.MXJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_MXJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.MXJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.MXJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_MXJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_training_operator_pkg_apis_v1_MXJobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_training_operator_pkg_apis_v1_PyTorchJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_PyTorchJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.PyTorchJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_PyTorchJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"elasticPolicy": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubeflow/training-operator/pkg/apis/v1.ElasticPolicy"),
						},
					},
					"pytorchReplicaSpecs": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.ReplicaSpec", "github.com/kubeflow/common/pkg/apis/common/v1.RunPolicy", "github.com/kubeflow/training-operator/pkg/apis/v1.ElasticPolicy"},
	}
}

func schema_training_operator_pkg_apis_v1_RDZVConf(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_training_operator_pkg_apis_v1_TFJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/training-operator/pkg/apis/v1.TFJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/v1.TFJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_TFJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.TFJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.TFJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_TFJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_training_operator_pkg_apis_v1_XGBoostJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_XGBoostJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/v1.XGBoostJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_training_operator_pkg_apis_v1_XGBoostJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
