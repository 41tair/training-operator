...
func addMPIDefaultingFuncs(scheme *runtime.Scheme) error {
...
func addMXDefaultingFuncs(scheme *runtime.Scheme) error {
	return RegisterDefaults(scheme)
}
...
func addTFDefaultingFuncs(scheme *runtime.Scheme) error {
	return RegisterDefaults(scheme)
}
...
func addXGBoostDefaultingFuncs(scheme *runtime.Scheme) error {
	return RegisterDefaults(scheme)
}
